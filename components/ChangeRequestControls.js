 ...
 */
export const ChangeRequestControls = ({ onAddItem, onImport, onExport, filters, setFilters, title, tableView, setTableView }) => {
    ...
    return html`
        <div className="controls-container manufacturer-controls">
            <div className="main-controls">
                <button type="button" className="btn" onClick=${onAddItem}>Add Change Request</button>
